  ...
  return (
    <>
      <form
        ...
        className="bg-[#272727] border border-white/[0.08] rounded-2xl p-3 flex flex-col sm:flex-row gap-3 shadow-[0_16px_48px_rgba(0,0,0,0.4)] mb-8"
      >
        <input
          type="text"
          value={search}
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <span className="inline-flex items-center gap-2 font-mono text-[11px] text-white/40">
          <span className="w-2 h-2 rounded-full bg-[#0075A2] animate-pulse" />
          Live PESO Bulletin
        </span>
      </div>
      ...
      {filteredJobs.length === 0 && (
        <div className="py-16 text-center bg-white/[0.02] border border-white/[0.06] rounded-2xl">
          <p className="text-sm text-white/50">No jobs match your search criteria.</p>
          <button
            onClick={() => {
              setSearch("");
